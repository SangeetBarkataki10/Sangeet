...
const ExperienceCard = ({
  ...
  return (
    <div
      className={`flex flex-col ${dark ? bgDark : bgLight} p-6 rounded-lg shadow-md m-4 w-90 h-95`}
    >
      <h3
        className={`text-xl font-bold text-center ${dark ? titleDark : titleLight}`}
      >
        {title}
      </h3>
      {link ? (
      ...
      <div className="mt-auto">
        ...
        <p className={`text-sm font-bold ${dark ? dateDark : dateLight}`}>
          {date}
        </p>
      </div>
    </div>
